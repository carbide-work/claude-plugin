...
Version `0.5.0` expands the existing address lookup tools to return verified Canadian as well as United States addresses. Tool schemas and authorization are unchanged.
...
git push git@github.com:carbide-work/claude-plugin.git claude-plugin-release:refs/tags/v0.5.0
...
6. Confirm MCP initialization and both portable plugin manifests advertise version `0.5.0`.
