...
Version `0.6.0` adds an estimator work-time calendar template to the existing calendar-template configuration tools. Owners and administrators can preview and edit its event title and description alongside appointment templates.
...
git push git@github.com:carbide-work/claude-plugin.git claude-plugin-release:refs/tags/v0.6.0
...
6. Confirm MCP initialization and both portable plugin manifests advertise version `0.6.0`.
