...
Version `2.0.0` removes the down payment request email template from the notification tool catalog and its accepted event type. Version `1.1.1` improved spoken-address resolution; version `1.1.0` added optional initial production blocks when promoting a request.
...
git push git@github.com:carbide-work/claude-plugin.git claude-plugin-release:refs/tags/v2.0.0
...
6. Confirm MCP initialization and both portable plugin manifests advertise version `2.0.0`.
