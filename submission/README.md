...
git push git@github.com:carbide-work/claude-plugin.git claude-plugin-release:refs/tags/v0.4.2
...
6. Confirm MCP initialization and both portable plugin manifests advertise version `0.4.2`.
